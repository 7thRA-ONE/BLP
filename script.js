 ...
 let canvas = document.getElementById('stage');
  ...
  if(value=="marinette"){
    ...
    const imageUrl = `images/marinette🍓☁️.jpg`;
  ...
  if(value=="lisa"){
    ...
    if (value === "jisso") {
  console.log("User entered jisso");
  const myImage = document.getElementById("myImage");
  const imageUrl = "images/jisso.jpg";
  const hoverUrl = "images/love.jpg";
  myImage.setAttribute("src", imageUrl);
  myImage.setAttribute("data-hover", hoverUrl);
  new Scene();
  ...
  const myImage = document.getElementById("myImage");
  const imageUrl = "images/jennie .jpg";
  const hoverUrl = "images/love.jpg";
  myImage.setAttribute("src", imageUrl);
  myImage.setAttribute("data-hover", hoverUrl);
  new Scene();
  ...
  if(value=="ladybug"){
    console.log("User entered Jennie");
    const myImage = document.getElementById("myImage");
    const imageUrl = `images/Ladybug.jpg`;
    const hoverUrl = "images/love.jpg";
    myImage.setAttribute("src", imageUrl);
    myImage.setAttribute("data-hover", hoverUrl);
    new Scene();
  ...
  if(value=="rose"){
    ...
    const myImage = document.getElementById("myImage");
    const imageUrl = `images/rose.jpg`;
    const hoverUrl = "images/love.jpg";
    myImage.setAttribute("src", imageUrl);
    myImage.setAttribute("data-hover", hoverUrl);
    new Scene();
    ...
    if (value === "felix") {
  console.log("User entered Felix");
  const myImage = document.getElementById("myImage");
  const imageUrl = "images/felix.jpg";
  const hoverUrl = "images/love.jpg";
  myImage.setAttribute("src", imageUrl);
  myImage.setAttribute("data-hover", hoverUrl);
  new Scene();
  canvas.style.display = "";
    ...
    if (value === "hyunjin") {
  console.log("User entered Hyunjin");
  const myImage = document.getElementById("myImage");
  const imageUrl = "images/hyunjin.jpg";
  const hoverUrl = "images/love.jpg";
  myImage.setAttribute("src", imageUrl);
  myImage.setAttribute("data-hover", hoverUrl);
  new Scene();
  canvas.style.display = "";
    ...
    if (value === "lee minho" ) {
  console.log("User entered Lee Minho/Lee Know");
  const myImage = document.getElementById("myImage");
  const imageUrl = "images/leeminho.jpg";
  const hoverUrl = "images/love.jpg";
  myImage.setAttribute("src", imageUrl);
  myImage.setAttribute("data-hover", hoverUrl);
  new Scene();
  canvas.style.display = "";
    ...
    if (value === "bangchan") {
  console.log("User entered Bangchan");
  const myImage = document.getElementById("myImage");
  const imageUrl = "images/bangchan.jpg";
  const hoverUrl = "images/love.jpg";
  myImage.setAttribute("src", imageUrl);
  myImage.setAttribute("data-hover", hoverUrl);
  new Scene();
  canvas.style.display = "";
    ...
    if (value === "han") {
  console.log("User entered Han");
  const myImage = document.getElementById("myImage");
  const imageUrl = "images/han.jpg";
  const hoverUrl = "images/love.jpg";
  myImage.setAttribute("src", imageUrl);
  myImage.setAttribute("data-hover", hoverUrl);
  new Scene();
  canvas.style.display = "";
    ...
    if (value === "seungmin") {
  console.log("User entered Seungmin");
  const myImage = document.getElementById("myImage");
  const imageUrl = "images/seungmin.jpg";
  const hoverUrl = "images/love.jpg";
  myImage.setAttribute("src", imageUrl);
  myImage.setAttribute("data-hover", hoverUrl);
  new Scene();
  canvas.style.display = "";
    ...
    if (value === "i.n") {
  console.log("User entered I.N");
  const myImage = document.getElementById("myImage");
  const imageUrl = "images/in.jpg";
  const hoverUrl = "images/love.jpg";
  myImage.setAttribute("src", imageUrl);
  myImage.setAttribute("data-hover", hoverUrl);
  new Scene();
